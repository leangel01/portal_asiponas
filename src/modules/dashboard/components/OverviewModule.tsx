...
export const OverviewModule: React.FC<{
  ...
  const metrics = [
    ...
    [
      "Capacidad TEUs",
      `${(current?.teu_capacity_annual || 0).toLocaleString("es-MX")} / año`,
      <FundOutlined />,
    ],
    [
      "Calado máximo",
  ...
  return (
    <>
      ...
      <Row gutter={[16, 16]} style={{ marginTop: 16 }}>
        ...
        <Col xs={24} lg={14}>
          <Card title="Noticias recientes" className="inner-card">
            <PressModule items={scoped.news.slice(0, 6)} />
          </Card>
        </Col>
      </Row>
    </>
